...
/// App更新提示框
showUpdateAlertDialog(context, FindNewsBean appUpdateInfo) async {
  var forceUpdate = appUpdateInfo.version.versionType == UpdateType.Force;
...
Future downloadApp(BuildContext context, FindNewsBean newsBean) async {
  var appUpdateInfo = newsBean.version;
  var url = appUpdateInfo.installUrl;
  var extDir = await getExternalStorageDirectory();
  debugPrint('extDir path: ${extDir.path}');
  String apkPath = '${extDir.path}/FunAndroid_${appUpdateInfo.newVersion}.apk';
